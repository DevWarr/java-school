...
{
    // Adding in a Logger.
    // MAKE SURE to use the actual class name!
    ...
    public ResponseEntity<?> listAllUsers(HttpServletRequest req)
    {
        // Time to log!
        // using the HttpServletRequest here allows us to just type "req.getRequestURI()" and the url will be right there '' '
